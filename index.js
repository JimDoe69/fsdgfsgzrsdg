...
bot.on('guildMemberAdd', function(member) {
    member.guild.channels.find('name', '#send').sendMessage(member.toString() + ' Welcome To The NIGGER™ Discord, You Are Now A Nigger, For A Custom Nigger Role Type !customrole');
